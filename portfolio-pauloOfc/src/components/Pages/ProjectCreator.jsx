    ...
    return (
        ...
        <div className="transition duration-700 ease-in-out w-[100%] min-h-[calc(100vh-5rem)] bg-zinc-100 dark:bg-black">
            <div className="w-[100%] h-[90vh] flex flex-wrap justify-center space-x-5 mt-20 max-md:pb-10">
                <div className="shadow w-[80%] md:h-[auto] flex flex-wrap justify-center max-lg:flex-col bg-zinc-300 dark:bg-zinc-900/40 m-10 mt-10 mb-10 relative">    
                    ...
                    <div className="lg:flex-1">
                        <div className="h-full flex justify-center flex-col items-center gap-5 text-black dark:text-white">
                            ...
                            <div className="w-[80%] pb-10 rounded-[15px] flex max-md:flex-col items-center justify-center gap-5 text-[1.5rem]">
                                ...
                                <span className="font max-md:text-[1.2rem]">pc.cordeirolima@gmail.com</span>
                            </div>
