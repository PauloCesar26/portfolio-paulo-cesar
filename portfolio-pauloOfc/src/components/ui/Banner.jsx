            ...
            <div className="animationInicial w-full font-[Arial] z-30 flex flex-col items-center">
              <div className="flex flex-col items-center justify-center">
                ...
                <p className="font text-[1.4rem] max-md:text-[1.1rem] font-medium md:w-[66%] max-md:w-[85%]">
                  Um desenvolvedor web apaixonado por tecnologia, movido por desafios e pela vontade de criar soluções com código e com um olhar atento para a experiência do usuário.
                </p>
              </div>
              <Link  
                to="contato"
