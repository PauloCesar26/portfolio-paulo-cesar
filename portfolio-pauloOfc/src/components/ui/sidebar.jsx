...
function SidebarMenu({
  ...
  return (
    <ul
      ...
      data-sidebar="menu"
      className={cn("flex w-full min-w-0 flex-col gap-2", className="mt-5")}
      {...props} />
  );
}
...
function SidebarMenuButton({
  ...
  const button = (
    <Comp
      ...
      className={cn(sidebarMenuButtonVariants({ variant, size }), className="pt-5 pb-5 font-semibold cursor-pointer hover:bg-zinc-400/30 transition duration-700 ease-in-out dark:hover:bg-zinc-800")}
      {...props} />
  )
