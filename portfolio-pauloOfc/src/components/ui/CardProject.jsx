...
function CardProject({imgSrc, altText, children, url, urlPage }) { 
  return (
    <>
        <div className="bg-zinc-200/40 border-2 hover:border-black border-zinc-300 dark:border-zinc-800 hover:dark:border-white flex flex-col max-sm:w-[80%] max-md:h-[470px] w-[420px] md:min-h-[550px] lg:min-h-[550px] dark:bg-zinc-900 dark:text-white rounded-[15px] overflow-hidden transition duration-800 ease-in-out hover:scale-[1.02]  shadow-card">
